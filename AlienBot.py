...
class AlienBot:
  ...
  def match_reply(self, reply):
    for key, value in self.alienbabble.items():
      ...
      if found_match and intent == 'cubed_intent':
  ...
  def no_match_intent(self):
    responses = ("Please tell me more. ", "Tell me more! ", 'Why do you say that?', "I see. Can you elaborate?", "I see. Can you elaborate? ", "Interesting. Can you tell me more? ", "I see. How do you think?", "Why? ", "How do you think I feel when you say that?")
    return random.choice(responses)
